# DOWNLOAD_DIR=src/main/extras/bigquery/drivers
...
# export BQ_JDBC_DRIVER_VERSION=1.2.16.1020
# export BQ_JDBC_DRIVER_VERSION=1.2.14.1017
export BQ_JDBC_DRIVER_VERSION=1.2.1.1001
